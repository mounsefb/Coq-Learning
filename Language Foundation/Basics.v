...
Proof. simpl. reflexivity. Qed.
Example test_andb:  false && false && true = false.
Proof. simpl. reflexivity. Qed.
...
Proof. simpl. reflexivity. Qed.
Example test_nandb2:               false !& false = true.
(* FILL IN HERE Admitted. *)
Proof. simpl. reflexivity. Qed.
Example test_nandb3:               false !& true = true.
(* FILL IN HERE Admitted. *)
Proof. simpl. reflexivity. Qed.
...
Proof.
  intros n. unfold plus. reflexivity.  Qed.
...
Theorem negb_involutive : forall b : bool,
  negb (negb b) = b.
Proof.
  intros b. unfold negb. destruct b eqn:E. 
  - reflexivity.
  - reflexivity.  Qed.
...
Theorem plus_1_neq_0' : forall n : nat,
  (n + 1) =? 0 = false.
Proof.
  intros [|n]. unfold eqb. unfold plus. 
  - reflexivity.
  - reflexivity.  Qed.
...
Proof.
  ...
  intro n.
  destruct n eqn:En.
    - unfold plus. unfold eqb. reflexivity.
    - unfold plus. unfold eqb. reflexivity.
Qed.
...
Proof.
  ...
  destruct b eqn:Eb.
    - destruct c eqn:Ec.
      -- unfold andb. unfold orb. intro H. reflexivity.
      -- unfold andb. unfold orb. intro H. rewrite <- H. reflexivity.
      - destruct c eqn:Ec.
      -- unfold andb. unfold orb. intro H. rewrite <- H. reflexivity.
      -- unfold andb. unfold orb. intro H. reflexivity.
Qed.
...
Proof.
  ...
  intro l.
  destruct l eqn:El.
    - unfold letter_comparison. reflexivity.
    - unfold letter_comparison. reflexivity.
    - unfold letter_comparison. reflexivity.
    - unfold letter_comparison. reflexivity.
    - unfold letter_comparison. reflexivity.
...
Definition grade_comparison (g1 g2 : grade) : comparison :=
  (* REPLACE THIS LINE WITH ":= _your_definition_ .". Admitted. *)
  (* match (letter_comparison (g1 letter), (g2 letter)) with
  |  Gt => Gt
  |  Eq => (modifier_comparison (g1 modifier) (g2 modifier))
  |  Lt => Lt
  end. *)
  match g1, g2 with
...
Definition lower_grade (g : grade) : grade :=
  (* REPLACE THIS LINE WITH ":= _your_definition_ .". Admitted. *)
  match g with 
  | Grade l1 m1 => match (l1, m1) with
  |   (F, Minus) => Grade F Minus
  |   (_, Minus) => Grade (lower_letter l1) Plus
  |   (_, _) => Grade l1  (lower_modifier m1)
    end
  end.
...
Theorem lower_grade_lowers :
  ...
  Proof.
    intros [l m] H. (* Déstructure g directement *)
    unfold lower_grade. (* Déplie la définition de lower_grade *)
    destruct l, m; simpl; try reflexivity. (* Déstructure en gérant tous les cas *)    (* Cas où l = F et m = Minus *)
    rewrite <- H.
    simpl.
    reflexivity.
  Qed.
...
Proof.
  intros.
  destruct late_days; simpl; reflexivity.
Qed.
...
Proof.
  (* FILL IN HERE Admitted. *)
  intros.
  unfold apply_late_policy. rewrite H.
  reflexivity.
Qed.
(** [] *)
...
Proof.
    intros late_days [l m] H1 H2.
    destruct late_days, l, m eqn:El; unfold apply_late_policy; rewrite H1; rewrite H2; simpl; reflexivity.
Qed.
(** [] *)
End LateDays.
