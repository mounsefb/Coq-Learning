...
Theorem add_inc_count : forall (l:bag) (n:nat),
...
Proof.
  (* FILL IN HERE Admitted. *)
  induction l1.
    - simpl. intro l2. rewrite app_nil_r. reflexivity.
    - simpl. intro l2. rewrite IHl1.  
...
Theorem eqblist_ind : forall (l1 l2: natlist) (n1 n2:nat),
  eqblist (n1::l2) (n2::l1) = (n1=?n2) && ( eqblist l1 l2 ).
  (* Admitted. *)
Proof.
  intros.
  assert ( H1 : forall c:bool, c && false = false ). {
          intro. destruct c; simpl; reflexivity.
        }
  (* induction l2.
    - destruct l1, n1, n2.
      * unfold eqblist. simpl. reflexivity.
      * unfold eqblist. simpl. reflexivity.
      * reflexivity.
      * reflexivity.
      * unfold eqblist. simpl. destruct l1; reflexivity.
      * unfold eqblist. simpl. reflexivity.
      * unfold eqblist. simpl. reflexivity.
      * simpl. destruct l1;rewrite H1; reflexivity.
    -  *)
  induction n1, n2.
   - simpl. destruct l1, l2.
    * simpl. reflexivity.
    * simpl. destruct l2; simpl; reflexivity.
    * simpl. destruct l1; simpl; reflexivity.
...
Proof.
  ...
  induction l.
    - simpl. reflexivity.
    - (* I need to prove that eqblist (n::l) (n::l) = true *)
    (* to do so, let's prove that eqblist (n1::l2) (n2::l1) = (n1=?n2) && (eqblist l1 l2) *)
    (* rewrite eqblist_ind. rewrite IHl. rewrite eqb_refl. simpl. reflexivity. *)
